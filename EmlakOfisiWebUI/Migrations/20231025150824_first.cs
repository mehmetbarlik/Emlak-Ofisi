...
namespace EmlakOfisiWebUI.Migrations
{
    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Estates",
                columns: new[] { "EstateId", "Address", "CategoryId", "EstateName", "ImageUrl", "Price", "RoomNumber", "Showcase", "Summary" },
                values: new object[,]
                {
                    { 1, "Filiz Sk.No:72/1 Bayrampaşa", 1, "Daire", "/images/1.jpg", 1700000m, 3, true, "" },
                    { 2, "Nur Sk.No:25/3 Bayrampaşa", 1, "Daire", "/images/2.jpg", 2500000m, 2, true, "" },
                    { 3, "Kanarya Sk.No:35/1 Bayrampaşa", 1, "Müstakil Ev", "/images/3.jpg", 1700000m, 4, true, "" },
                    { 4, "Petek Sk.No:15/4 Bayrampaşa", 2, "Daire", "/images/4.jpg", 10000m, 3, false, "" },
                    { 5, "Sert Sk.No:11/2 Bayrampaşa", 3, "Daire", "/images/5.jpg", 800m, 3, false, "" }
                });
